...
class CatLevelDetailController extends Controller
{
	/**
	 ...
	 * @return CatLevelDetail the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=CatLevelDetail::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param CatLevelDetail $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cat-level-detail-form')
		{
