...
class MaterialLevelController extends Controller
{
	...
	{
		$model=new MaterialLevel;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['MaterialLevel']))
		{
			$model->attributes=$_POST['MaterialLevel'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->pk_material_level));
		}
	 ...
	 * @return MaterialLevel the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=MaterialLevel::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='material-level-form')
		{
